...
const Contact = () => {
  return (
    <Box sx={{ backgroundImage:`linear-gradient(90deg, rgba(250, 250, 250, 1), rgba(260, 260, 260, 0.05)),url(${background})` }}>
    <Box sx={{ maxWidth: '90rem', margin: 'auto', width: '90%', padding: {xs: '6rem 0', md: '9rem 0'}  }}>
      <Stack sx={{alignItems: 'center', textAlign: 'center'}} spacing={3}>
        <Typography variant='h2' sx={{ fontWeight: '700', fontSize: {xs: '2.5rem', sm:'3.75rem' }}}>CONTACT</Typography>
